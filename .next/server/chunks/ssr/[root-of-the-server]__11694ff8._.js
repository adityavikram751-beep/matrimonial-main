...
function AdminProfilePage() {
  ...
  ----------------------------*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!loading && admin && admin.notifications) {
            ...
            try {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["connectSocket"])(admin._id || admin.id || "");
            } catch (e) {
        ...
        try {
            ...
            if (json.success) {
                ...
                if (values.notifications === true) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["connectSocket"])(updatedAdmin._id || updatedAdmin.id || "");
                } else {
  ...
  ----------------------------*/ const handleNotificationToggle = async (value)=>{
        try {
            ...
            if (json.success) {
                ...
                window.dispatchEvent(new Event("adminProfileUpdated"));
                if (value) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["connectSocket"])(updated._id || updated.id || "");
                } else {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["disconnectSocket"])();
                }
                setToast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11694ff8._.js.map