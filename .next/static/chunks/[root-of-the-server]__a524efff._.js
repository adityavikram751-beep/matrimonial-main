    ...
    const loadSidebarProfile = ()=>{
        try {
            ...
            if (raw) {
                ...
                setProfile({
                    name: (data === null || data === void 0 ? void 0 : data.name) || 'Super Admin',
                    profileImage: (data === null || data === void 0 ? void 0 : data.profileImage) || '/profile.png',
                    role: (data === null || data === void 0 ? void 0 : data.role) || 'Super Admin'
                });
            }
        } catch (e) {}
    };
