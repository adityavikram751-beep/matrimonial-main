  ...
  ----------------------------*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminProfilePage.useEffect": ()=>{
            if (!loading && admin && admin.notifications) {
                ...
                try {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["connectSocket"])(admin._id || admin.id || "");
                } catch (e) {
        ...
        try {
            ...
            if (json.success) {
                ...
                if (values.notifications === true) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["connectSocket"])(updatedAdmin._id || updatedAdmin.id || "");
                } else {
  ...
  ----------------------------*/ const handleNotificationToggle = async (value)=>{
        try {
            ...
            if (json.success) {
                ...
                window.dispatchEvent(new Event("adminProfileUpdated"));
                if (value) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["connectSocket"])(updated._id || updated.id || "");
                } else {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$js__$5b$client$5d$__$28$ecmascript$29$__["disconnectSocket"])();
                }
                setToast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59b78c16._.js.map